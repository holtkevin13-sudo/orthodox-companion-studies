...
const FATHER_PAGES = {
  ...
  'Photios the Great': 'father-cards/photios-the-great.html',
  'Theodore the Studite': 'father-cards/theodore-the-studite.html',
  'Cyril and Methodius': 'father-cards/cyril-and-methodius.html',
  'Mark of Ephesus': 'father-cards/mark-of-ephesus.html'
  ...
  patristics: {
    '40-week': {
      ...
      requiredResources: [
        ...
        { id: 'holmes-apostolic-fathers',      category: 'primary', title: 'The Apostolic Fathers', author: 'Holmes (ed.)', edition: 'Baker Academic, 3rd ed.', phase: 'Weeks 1–4', essential: true },
        { id: 'anf-vols-1-3-5',                category: 'primary', title: 'Ante-Nicene Fathers, Vols. 1, 3, 5', details: 'Justin · Tertullian · Cyprian · Irenaeus', phase: 'Weeks 5–13', essential: true },
        { id: 'irenaeus-against-heresies',     category: 'primary', title: 'Against Heresies', author: 'Irenaeus of Lyons', details: 'Standalone edition or ANF Vol. 1', phase: 'Weeks 9–13', essential: true },
        { id: 'npnf-series-1-2',               category: 'primary', title: 'Nicene & Post-Nicene Fathers, Series I & II', details: 'Athanasius · Cappadocians · Chrysostom · Leo (NPNF 1.12) · John of Damascus (NPNF 2.9)', phase: 'Weeks 14–38', essential: true },
        { id: 'chrysostom-on-priesthood',      category: 'primary', title: 'On the Priesthood', author: 'John Chrysostom', details: 'In NPNF 1.9', phase: 'Weeks 20–21', essential: true },
        { id: 'cyril-on-unity-of-christ',      category: 'primary', title: 'On the Unity of Christ', author: 'Cyril of Alexandria', edition: 'SVS Press · ~$20 · trans. McGuckin', phase: 'Weeks 29–30', essential: true, toPurchase: true },
        { id: 'pseudo-dionysius-complete',     category: 'primary', title: 'Pseudo-Dionysius: The Complete Works', edition: 'Paulist Press · ~$25 · trans. Luibheid', phase: 'Weeks 32–33', essential: true, toPurchase: true },
        { id: 'maximus-two-hundred-chapters',  category: 'primary', title: 'Two Hundred Chapters on Theology', author: 'Maximus the Confessor', edition: 'SVS Press · ~$20', phase: 'Weeks 34–36', essential: true, toPurchase: true },
        { id: 'maximus-cosmic-mystery',        category: 'primary', title: 'On the Cosmic Mystery of Jesus Christ', author: 'Maximus the Confessor', edition: 'Paulist Press · ~$25 · optional but recommended', phase: 'Week 36', essential: false, toPurchase: true },

        // Biblical Texts — Scripture track
        { id: 'eob-new-testament',             category: 'biblical', title: 'Eastern Orthodox Bible', details: 'New Testament', phase: 'All weeks', essential: true },
        { id: 'lexham-english-septuagint',     category: 'biblical', title: 'Lexham English Septuagint', details: 'Old Testament + Psalms', phase: 'All weeks', essential: true },

        // Secondary Reading — scholarly companions, scheduled per phase (Part I)
        { id: 'pelikan-christian-tradition-v1',    category: 'secondary', title: 'The Christian Tradition, Vol. 1', author: 'Jaroslav Pelikan', details: 'Ch. 1–5', phase: 'Weeks 1–6', essential: true },
        { id: 'torrance-trinitarian-faith',        category: 'secondary', title: 'The Trinitarian Faith', author: 'T. F. Torrance', details: 'Intro + Ch. 1', phase: 'Week 4', essential: false },
        { id: 'osborn-justin-martyr',              category: 'secondary', title: 'Justin Martyr', author: 'Eric Osborn', phase: 'Weeks 5–6', essential: false },
        { id: 'dunn-tertullian',                   category: 'secondary', title: 'Tertullian', author: 'Geoffrey D. Dunn', phase: 'Week 7', essential: false },
        { id: 'brent-cyprian-roman-carthage',      category: 'secondary', title: 'Cyprian and Roman Carthage', author: 'Allen Brent', phase: 'Week 8', essential: false },
        { id: 'minns-irenaeus-introduction',       category: 'secondary', title: 'Irenaeus: An Introduction', author: 'Denis Minns', phase: 'Weeks 9–10', essential: false },
        { id: 'behr-irenaeus-of-lyons',            category: 'secondary', title: 'Irenaeus of Lyons', author: 'John Behr', phase: 'Weeks 11–13', essential: false },
        { id: 'weinandy-athanasius-intro',         category: 'secondary', title: 'Athanasius: A Theological Introduction', author: 'Thomas Weinandy', phase: 'Week 14', essential: false },
        { id: 'anatolios-athanasius-coherence',    category: 'secondary', title: 'Athanasius: The Coherence of His Thought', author: 'Khaled Anatolios', phase: 'Week 15', essential: false },
        { id: 'behr-nicene-faith-v2',              category: 'secondary', title: 'The Nicene Faith, Vol. 2', author: 'John Behr', phase: 'Week 16', essential: false },
        { id: 'louth-origins-mystical-tradition',  category: 'secondary', title: 'Origins of the Christian Mystical Tradition', author: 'Andrew Louth', details: 'Ch. 4–5 (Week 17) · Ch. 6 (Week 33)', phase: 'Weeks 17, 33', essential: false },
        { id: 'daley-gregory-of-nazianzus',        category: 'secondary', title: 'Gregory of Nazianzus', author: 'Brian Daley', phase: 'Week 18', essential: false },
        { id: 'norris-faith-gives-fullness',       category: 'secondary', title: 'Faith Gives Fullness to Reasoning', author: 'Frederick Norris', details: 'Commentary on Orations 29–31', phase: 'Week 19', essential: false },
        { id: 'kelly-golden-mouth-chrysostom',     category: 'secondary', title: 'Golden Mouth: The Story of John Chrysostom', author: 'J. N. D. Kelly', phase: 'Weeks 20–25', essential: false },

        // Secondary Reading — Part II scholarly companions
        { id: 'mcguckin-cyril-christological',     category: 'secondary', title: 'Saint Cyril of Alexandria and the Christological Controversy', author: 'John McGuckin', phase: 'Weeks 29–30', essential: false },
        { id: 'neil-leo-the-great',                category: 'secondary', title: 'Leo the Great', author: 'Bronwen Neil', phase: 'Week 31', essential: false },
        { id: 'sellers-council-of-chalcedon',      category: 'secondary', title: 'The Council of Chalcedon', author: 'R. V. Sellers', phase: 'Week 31', essential: false },
        { id: 'louth-denys-areopagite',            category: 'secondary', title: 'Denys the Areopagite', author: 'Andrew Louth', phase: 'Weeks 32–33', essential: false },
        { id: 'louth-maximus-confessor',           category: 'secondary', title: 'Maximus the Confessor', author: 'Andrew Louth', phase: 'Weeks 34–35', essential: false },
        { id: 'thunberg-man-and-cosmos',           category: 'secondary', title: 'Man and the Cosmos: The Vision of St. Maximus the Confessor', author: 'Lars Thunberg', phase: 'Week 36', essential: false },
        { id: 'louth-john-damascene',              category: 'secondary', title: 'St John Damascene: Tradition and Originality in Byzantine Theology', author: 'Andrew Louth', phase: 'Weeks 37–38', essential: false }
      ],
